...
class FeesController {
    ...
    async get(req, res, next) {
        try {
            let response = await FeesService.getAll();
            if (response) {

                return res.status(httpStatus.OK).json(new APIResponse(response, "Fees Featch SuccessFully"))
            }
        } catch (error) {
...
var exports = (module.exports = new FeesController());
